...
public class Mobil {
    ...
    public void rem() {
        ...
        System.out.println("\nKecepatan mobil saat ini : " + this.getKecepatanActual() + " Km/jam");
    }
    ...
    public void gantiGigi(int Gigi) {
        ...
        System.out.println("Posisi Gigi mobil : " + this.getGigi());
        System.out.println("\nPercepatan Mobil : " + this.getPercepatan() + " Km/jam");
    }
